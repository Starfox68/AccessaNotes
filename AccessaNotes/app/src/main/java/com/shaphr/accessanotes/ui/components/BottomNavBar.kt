...
fun StyleIcons(iconName: String){
    ...
    return Icon(shape, contentDescription = iconName, mod, Color(0xFF427DDE))
}
...
fun BottomNavBar(navController: NavController) {
    ...
    NavigationBar(modifier = Modifier.defaultMinSize(50.dp, 90.dp)) {
        NavigationBarItem(
            ...
            label = {Text("All Notes", color = Color(0xFF427DDE))},
        ...
        NavigationBarItem(
            icon = { StyleIcons("Add")},
            label = {Text("New Session", color = Color(0xFF427DDE))},
        ...
        NavigationBarItem(
            ...
            label = {Text("Account", color = Color(0xFF427DDE))},
